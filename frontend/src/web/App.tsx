 ...
 *
 * Renders the main single-page application UI and provides example handlers to:
 * - perform a GET request to fetch page configuration,
 * - display a StatusToast notification,
 * - show Modal alert, confirm, and prompt dialogs.
 *
